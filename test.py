...
with open(r"/Users/feliperomagna/Document/data/butterfly_comfyui/workflow_butterfly_flux.json", "r", encoding="utf-8") as f:
    workflow_data = f.read()

workflow = json.loads(workflow_data)

#==================================
image_dir = "/Users/feliperomagna/Document/data/butterfly_comfyui/sdxl_step1"

# Obter todos os arquivos de imagem
image_files = sorted([f for f in os.listdir(image_dir) if f.endswith('.png')])

for i in range(0, 104):
    image_file = os.path.join(image_dir, f"butterfly{i:04d}.png")
