...
with open(r"/Users/feliperomagna/Document/data/butterfly_comfyui/workflow_but_flux_final.json", "r", encoding="utf-8") as f:
    workflow_data = f.read()

workflow = json.loads(workflow_data)

#==================================
image_dir = "/Users/feliperomagna/Document/data/butterfly_comfyui/frames_red"
...
# Loop principal
for i in range(start_index, 140):
    image_file = os.path.join(image_dir, f"frame_{i:04d}.png")
    ...
    workflow["24"]["inputs"]["image"] = image_file
    ...
    try:
        ...
        # Salvar progresso
        save_progress(i + 1)  # Salvar o próximo índice a ser processado

    except Exception as e:
        print(f"Erro ao conectar ou processar imagens: {e}")
        save_progress(i)  # Salvar o índice atual antes de interromper
